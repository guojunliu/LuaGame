...
namespace XLua.CSObjectWrap
{
    ...
    public class VirtualInputMoveDirectionWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(VirtualInputMoveDirection);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetDirection", _m_GetDirection);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetLenPercent", _m_GetLenPercent);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new VirtualInputMoveDirection();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to VirtualInputMoveDirection constructor!");
        ...
        static int _m_OnPointerDown(RealStatePtr L)
        {
		    try {
                ...
                VirtualInputMoveDirection gen_to_be_invoked = (VirtualInputMoveDirection)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetDirection(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetDirection(  );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetLenPercent(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetLenPercent(  );
